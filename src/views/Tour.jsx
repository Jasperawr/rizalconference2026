...
const Tour = () => {
  return (
    <div id="Tour" className="bg-[#f5f5f5] relative w-full  py-20 px-50">
      {/* Overlay */}
      ...
      <div className="relative z-50 w-full flex flex-col flex-col-reverse gap-10 justify-between items-center">
        <div className="flex gap-5">
          <Carousel />
          <div className="w-[350px] h-[400px] rounded-2xl overflow-hidden shadow-xl border border-gray-900/20">
            <iframe
        ...
        <div className="flex flex-col items-center">
          <div className="relative z-50  align-center">
            {/* <div className="border rounded border-gray-50 w-10 mb-3"></div> */}
            <p className="text-4xl uppercase text-gray-900 font-lora">Tour</p>
          </div>
          {/* <div className="text-gray-700 text-center pt-4">
